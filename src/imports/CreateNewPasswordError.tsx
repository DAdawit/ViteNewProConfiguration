import svgPaths from "./svg-pjvopw8lnt";
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center not-italic relative shrink-0 text-nowrap w-full whitespace-pre">
      <p className="font-['Poppins:Medium',sans-serif] leading-[26px] relative shrink-0 text-[#27190c] text-[20px] tracking-[-0.6538px]">Create New Password</p>
      <p className="font-['Poppins:Regular',sans-serif] leading-[21px] relative shrink-0 text-[14px] text-center text-neutral-500 tracking-[-0.4577px]">Restore Your Password</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Line">
          <g id="Shape">
            <path d={svgPaths.pcf44f00} stroke="var(--stroke-0, #171717)" strokeLinecap="round" strokeLinejoin="round" />
            <path d={svgPaths.p37cf75f0} stroke="var(--stroke-0, #171717)" strokeLinecap="round" strokeLinejoin="round" />
          </g>
        </g>
      </svg>
    </div>
...
function Cursor() {
  return (
    <div className="h-[20px] relative shrink-0 w-[2px]" data-name="Cursor">
      <div className="absolute bg-neutral-900 inset-0" data-name="Rectangle" />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Line">
          <g id="Shape">
            <path d={svgPaths.pcf44f00} stroke="var(--stroke-0, #EF4444)" strokeLinecap="round" strokeLinejoin="round" />
            <path d={svgPaths.p37cf75f0} stroke="var(--stroke-0, #EF4444)" strokeLinecap="round" strokeLinejoin="round" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#021828] text-[14px] tracking-[1.75px] uppercase w-full">
...
function Line3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Line">
          <path d={svgPaths.p16f4e300} id="Shape" stroke="var(--stroke-0, #171717)" strokeLinecap="round" />
        </g>
      </svg>
    </div>
  );
...
function HelperText() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Helper text">
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-nowrap text-red-500 tracking-[-0.4577px]">
        <p className="leading-[21px] whitespace-pre">Your Passwords do not match</p>
      </div>
    </div>
  );
}
...
function Line6() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Line">
          <path d="M6 18L18 6M6 6L18 18" id="Shape" stroke="var(--stroke-0, #171717)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
...
function Content2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content">
      <p className="font-['Manrope:Medium',sans-serif] leading-[1.55] not-italic relative shrink-0 text-[12px] text-neutral-900 w-full">At least one number</p>
    </div>
  );
}
...
function Content4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content">
      <p className="font-['Manrope:Medium',sans-serif] leading-[1.55] not-italic relative shrink-0 text-[12px] text-neutral-900 w-full">At least one special character (e.g., !, @, #, $).</p>
    </div>
  );
}
...
function Toast() {
  return (
    <div className="bg-neutral-100 relative rounded-[6px] shrink-0 w-full" data-name="Toast">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-center pl-[10px] pr-[8px] py-[8px] relative w-full">
          <Content1 />
          <Content3 />
          <Content5 />
        </div>
    ...
    <div className="bg-neutral-300 relative rounded-[4px] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[4px] items-center justify-center px-[24px] py-[8px] relative w-full">
          <p className="font-['Poppins:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[14px] text-center text-neutral-600 text-nowrap tracking-[-0.4577px] whitespace-pre">{`Reset Password `}</p>
        </div>
      </div>
    </div>
  );
...
export default function CreateNewPasswordError() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="Create New Password-error">
      <InputSideParentCont />
