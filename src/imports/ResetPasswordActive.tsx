import svgPaths from "./svg-3anpm1owge";
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center not-italic relative shrink-0 text-nowrap w-full whitespace-pre">
      <p className="font-['Poppins:Medium',sans-serif] leading-[26px] relative shrink-0 text-[#27190c] text-[20px] tracking-[-0.6538px]">Reset Password</p>
      <p className="font-['Poppins:Regular',sans-serif] leading-[21px] relative shrink-0 text-[14px] text-center text-neutral-500 tracking-[-0.4577px]">Restore access to your account</p>
    </div>
  );
}
    ...
    <div className="bg-[#c17c3e] relative rounded-[4px] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[4px] items-center justify-center px-[24px] py-[8px] relative w-full">
          <p className="font-['Poppins:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[14px] text-center text-neutral-50 text-nowrap tracking-[-0.4577px] whitespace-pre">{`Reset Password `}</p>
        </div>
      </div>
    </div>
  );
...
export default function ResetPasswordActive() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="Reset password-active">
      <InputSideParentCont />
