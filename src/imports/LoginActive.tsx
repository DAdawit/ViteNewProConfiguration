import svgPaths from "./svg-amact390at";
      ...
      <div className="absolute inset-[-42.64%_-64%_-85.03%_-64%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 57 57">
          <g id="Frame 1000005910">
            <g filter="url(#filter0_d_1_3916)" id="Ellipse 1">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="56.918" id="filter0_d_1_3916" width="57" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_1_3916" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_1_3916" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function InputFrame() {
  return (
    <div className="bg-neutral-50 relative rounded-[6px] shrink-0 w-full" data-name="Input Frame">
      ...
      <div aria-hidden="true" className="absolute border border-neutral-100 border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
}
    ...
    <div className="bg-[#c17c3e] relative rounded-[4px] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[4px] items-center justify-center px-[24px] py-[8px] relative w-full">
          <p className="font-['Poppins:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[14px] text-center text-neutral-50 text-nowrap tracking-[-0.4577px] whitespace-pre">Login</p>
        </div>
      </div>
    </div>
  );
...
export default function LoginActive() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="Login-active">
      <InputSideParentCont />
