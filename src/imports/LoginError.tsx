import svgPaths from "./svg-gxhgt4cavc";
      ...
      <div className="absolute inset-[-42.64%_-64%_-85.03%_-64%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 57 57">
          <g id="Frame 1000005910">
            <g filter="url(#filter0_d_1_3951)" id="Ellipse 1">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="56.918" id="filter0_d_1_3951" width="57" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_1_3951" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_1_3951" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function Content() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="Content">
      <p className="font-['Manrope:Medium',sans-serif] leading-[1.55] not-italic relative shrink-0 text-[14px] text-neutral-900 text-nowrap whitespace-pre">Your username or password is incorrect</p>
    </div>
  );
}
...
function Toast() {
  return (
    <div className="bg-red-50 box-border content-stretch flex gap-[8px] items-center overflow-clip pl-[10px] pr-[8px] py-[8px] relative rounded-[6px] shrink-0 w-[356px]" data-name="Toast">
      <Content1 />
    </div>
  );
}
...
function InputFrame() {
  return (
    <div className="bg-red-50 relative rounded-[6px] shrink-0 w-full" data-name="Input Frame">
...
export default function LoginError() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="Login-error">
      <InputSideParentCont />
