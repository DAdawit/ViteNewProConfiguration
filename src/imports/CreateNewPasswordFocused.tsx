import svgPaths from "./svg-rkf4424gag";
...
function InputFrame() {
  return (
    <div className="bg-neutral-50 relative rounded-[6px] shrink-0 w-full" data-name="Input Frame">
      ...
      <div aria-hidden="true" className="absolute border border-[#c17c3e] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
}
...
function Content() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content">
      <p className="font-['Manrope:Medium',sans-serif] leading-[1.55] not-italic relative shrink-0 text-[12px] text-neutral-900 w-full">Minimum 8 letters</p>
    </div>
  );
}
...
function Content2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content">
      <p className="font-['Manrope:Medium',sans-serif] leading-[1.55] not-italic relative shrink-0 text-[12px] text-neutral-900 w-full">Password must include at least one number and one symbol.</p>
    </div>
  );
}
...
export default function CreateNewPasswordFocused() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="Create New Password-focused">
      <InputSideParentCont />
