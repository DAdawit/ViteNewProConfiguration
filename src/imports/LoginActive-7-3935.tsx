import svgPaths from "./svg-34uob2d80c";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Line">
          <path d={svgPaths.p353cbe00} id="Shape" stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
...
function TextCursor() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Text + Cursor">
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-neutral-50 text-nowrap tracking-[-0.4577px]">
...
function InputFrame() {
  return (
    <div className="bg-neutral-900 relative rounded-[6px] shrink-0 w-full" data-name="Input Frame">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[12px] items-center px-[12px] py-[10px] relative w-full">
          <Frame3 />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-neutral-800 border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
}
...
function Line2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Line">
          <path d={svgPaths.p16f4e300} id="Shape" stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" />
        </g>
      </svg>
    </div>
  );
...
function Cursor() {
  return (
    <div className="h-[20px] relative shrink-0 w-[2px]" data-name="Cursor">
      <div className="absolute bg-neutral-50 inset-0" data-name="Rectangle" />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Line">
          <g id="Shape">
            <path d={svgPaths.pcf44f00} stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" strokeLinejoin="round" />
            <path d={svgPaths.p37cf75f0} stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" strokeLinejoin="round" />
          </g>
        </g>
      </svg>
    </div>
    ...
    <div className="bg-[#c17c3e] relative rounded-[4px] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[4px] items-center justify-center px-[24px] py-[8px] relative w-full">
          <p className="font-['Poppins:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[14px] text-center text-neutral-900 text-nowrap tracking-[-0.4577px] whitespace-pre">Login</p>
        </div>
      </div>
    </div>
  );
...
export default function LoginActive() {
  return (
    <div className="bg-black content-stretch flex items-start relative size-full" data-name="Login-active">
      <InputSideParentCont />
