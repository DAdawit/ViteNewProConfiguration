import svgPaths from "./svg-jb5e5641ce";
...
function Line3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Line">
          <path d={svgPaths.p16f4e300} id="Shape" stroke="var(--stroke-0, #1A1A1A)" strokeLinecap="round" />
        </g>
      </svg>
    </div>
  );
...
export default function CreateNewPasswordTyping() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="Create New Password-typing">
      <InputSideParentCont />
