import svgPaths from "./svg-rv34a0qt3p";
...
function InputFrame() {
  return (
    <div className="bg-neutral-800 relative rounded-[6px] shrink-0 w-full" data-name="Input Frame">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[12px] items-center px-[12px] py-[10px] relative w-full">
          <Frame />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#27190c] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
}
...
export default function Login() {
  return (
    <div className="bg-black content-stretch flex items-start relative size-full" data-name="Login">
      <InputSideParentCont />
