  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[25%] xxl:top-[20%] right-0 z-50 grid w-full max-w-[calc(100%-1rem)] lg:max-w-[calc(100%-2rem)] translate-x-[-2%] translate-y-[-50%] gap-5 rounded-lg border shadow-lg duration-200 overflow-x-scroll",
          className,
        )}
        {...props}
      >
...
function DialogHeader({ className, ...props }) {
  return (
    <div
      ...
      className={cn(
        "flex justify-between items-center p-5 bg-neutral-100 rounded-t-[20px] border-b border-b-neutral-100",
        className,
      )}
      {...props}
    />
