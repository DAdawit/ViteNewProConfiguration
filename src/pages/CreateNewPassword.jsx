...
import SuccessDialgo from "@/InternalComponents/common/Alert/SuccessDialgo";
...
const CreateNewPassword = () => {
    ...
    return (
      <MyLayout>
        <div className="w-full flex flex-col h-full">
          <div className="w-full flex flex-col rounded-xl p-5 gap-2.5">
            <Danger message={languageTranslate(language, "serverError")} />
            ...
            <div className="w-full flex flex-col gap-10">
              <div className="w-full flex flex-col">
                <h1 className="text-primary-900 font-medium text-4xl leading-[125%] tracking-tight text-center capitalize">
                  {languageTranslate(language, "createNewPasswordTitle")}
                </h1>
              ...
              <Button
                type="button"
                className="rounded-full gap-1 py-0.5 px-1.5 bg-primary-700 hover:bg-primary-900 text-neutral-50"
  ...
  return (
    <MyLayout>
        ...
        <div className="w-full flex flex-col rounded-xl p-5 gap-2.5 shadow-[0_1px_2px_0px_rgba(16,24,40,0.04)]">
          ...
          >
            <div className="w-full flex flex-col gap-10">
              ...
              <div
                className={`w-full flex flex-col rounded-[6px] pr-2 pl-2.5 py-2 bg-neutral-100 gap-1 ${
      ...
      <SuccessDialgo open={showSuccess} />
    </MyLayout>
  );
};
